module Magiika::Typing
  ...
  def union_type!(target : NodeAny, _union : Node::Union)
  ...
  def inherits_type!(target : NodeAny, _type : NodeType, error : ::Bool = true)
  ...
  def exact_type!(target : NodeAny, _type : NodeType)
  ...
  def type!(target : NodeAny, _type : NodeType)
